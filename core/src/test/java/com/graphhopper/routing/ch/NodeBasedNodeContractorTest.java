...
public class NodeBasedNodeContractorTest {
    ...
    private NodeContractor createNodeContractor(CHGraph chGraph) {
        PrepareGraph prepareGraph = PrepareGraph.nodeBased(chGraph.getNodes(), chGraph.getOriginalEdges());
        PrepareGraph.buildFromGraph(prepareGraph, chGraph.getBaseGraph(), chGraph.getCHConfig().getWeighting());
